  ...
  const nav = (
    <div className="flex gap-2" role="tablist" aria-label="Data structure">
      <button
        ...
        className="px-4 py-2 rounded-lg text-sm font-medium transition-colors aria-selected:bg-accent aria-selected:text-white bg-slate-100 text-slate-700 hover:bg-slate-200"
      >
        Linked List
      </button>
    </div>
